...
export default {
    ...
    data() {
        return {
            ...
            expert1Logo: language.expert1Logo ? import.meta.env.BASE_URL + import.meta.env.VITE_APP_MEDIA_LOCATION + language.expert1Logo : "",
            expert2: language.expert2,
            expert2Description: language.expert2Description,
            expert2Logo: language.expert2Logo ? import.meta.env.BASE_URL + import.meta.env.VITE_APP_MEDIA_LOCATION + language.expert2Logo : "",
            expert3: language.expert3,
            expert3Description: language.expert3Description,
            expert3Logo: language.expert3Logo ? import.meta.env.BASE_URL + import.meta.env.VITE_APP_MEDIA_LOCATION + language.expert3Logo : "",
