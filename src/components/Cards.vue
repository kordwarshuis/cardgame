...
<div>
    ...
    <p class="categoryLinks">
        ...
        <a v-for="category in categories" @click="showItemsInSelectedCategory(category)" :data-category="category.name" :key="category.name">{{ category.name }}
            ({{ category.numberOfItems }})</a>
    </p>
    <Search />
    <div class="grid">
        <!-- <transition name="fade"> -->
        <a v-for="item in categoryItemsContent" data-shorttext="" :data-id="item['id']" :key="item.prejudice" class="grid__item" href="#" @click="showCardIntro">
            <div class="box">
