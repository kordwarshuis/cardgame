...
<script>
  ...
  export default {
    ...
    methods: {
      fetchData() {
        function a(t) {
          this.createCategoryNames(t);
          console.log("a uitgevoerd " + t);
        };
      ...
      fetchData2() {
        return axios.get("https://blockchainbird.com/t/cardgame-resources/data/data-csv-cors.php")
          .then(response => {
            ...
            console.log('d3.csvParse(response.data): ', d3.csvParse(response.data.columns));
            
            return d3.csvParse(response.data);
            // console.log('a(value[0]): ', a(value[0]));
